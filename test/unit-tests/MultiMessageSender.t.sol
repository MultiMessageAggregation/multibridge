...
contract MultiMessageSenderTest is Setup {
    ...
    function test_remote_call() public {
        ...
        sender.remoteCall{value: fee}(DST_CHAIN_ID, address(42), bytes("42"), 0, refundAddress, expiration);
    ...
    function test_remote_call_refund() public {
        ...
        sender.remoteCall{value: nativeValue}(DST_CHAIN_ID, address(42), bytes("42"), 0, refundAddress, expiration);
    ...
    function test_remote_call_only_caller() public {
        ...
        sender.remoteCall(DST_CHAIN_ID, address(42), bytes("42"), 0, refundAddress, EXPIRATION_CONSTANT);
    }
    ...
    function test_remote_call_invalid_expiration() public {
        ...
        sender.remoteCall(DST_CHAIN_ID, address(42), bytes("42"), 0, refundAddress, invalidExpMin);

        vm.expectRevert(Error.INVALID_EXPIRATION_DURATION.selector);
        sender.remoteCall(DST_CHAIN_ID, address(42), bytes("42"), 0, refundAddress, invalidExpMax);
    ...
    function test_remote_call_chain_id_is_sender_chain() public {
        ...
        sender.remoteCall(block.chainid, address(42), bytes("42"), 0, refundAddress, EXPIRATION_CONSTANT);
    }
    ...
    function test_remote_call_zero_chain_id() public {
        ...
        sender.remoteCall(0, address(42), bytes("42"), 0, refundAddress, EXPIRATION_CONSTANT);
    }
    ...
    function test_remote_call_zero_target_address() public {
        ...
        sender.remoteCall(DST_CHAIN_ID, address(0), bytes("42"), 0, refundAddress, EXPIRATION_CONSTANT);
    }
    ...
    function test_remote_call_zero_receiver_address() public {
        ...
        dummySender.remoteCall(DST_CHAIN_ID, address(42), bytes("42"), 0, refundAddress, EXPIRATION_CONSTANT);
    }
